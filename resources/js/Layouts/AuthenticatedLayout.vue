                    ...
                    <div class="flex justify-between h-14 items-center">
                        ...
                        <div class="w-full flex justify-center items-center gap-2">
                            ...
                            >
                                ...
                                <!-- sun icon -->
                                <svg
                                    class="swap-on size-7 fill-yellow-100 group-hover:fill-yellow-200 transition-all duration-300"
                                ...
                                <!-- moon icon -->
                                <svg
                                    class="swap-off size-7 fill-sky-200 group-hover:fill-sky-300 transition-all duration-300"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
