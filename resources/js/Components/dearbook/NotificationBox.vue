...
<template>
    <div class="z-50 w-full lg:w-1/4 toast notification" id="notification-box">
        <div class="flex justify-between shadow-lg alert"
            :class="title === 'Info' ? 'bg-gray-200' : 'bg-red-200'">
