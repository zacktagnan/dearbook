...
const emit = defineEmits([
    ...
    'callActiveShowNotificationFromEdit',
]);
...
const processErrors = (errors) => {
    ...
    emit("callActiveShowNotificationFromEdit", errorProcessed);
};
...
<template>
    <div class="flex gap-2 mt-2.5">
        ...
        <div class="flex flex-col w-full gap-0">
            <TextareaInput
                ref="commentTextAreaRef" v-model="commentToEditText" :placeholder="'Comentar como ' + $page.props.auth.user.name" :class="'w-full rounded-none rounded-t-lg border-0 bg-gray-200/50 text-[15px] ring-0 focus:ring-0 resize-none pt-2 max-h-28'" rows="1"
                @callFocusIn="onFocusIn" @callFocusOut="onFocusOut" :block-item-class-name="'edit_block_item'"
            />
            ...
            <div class="flex items-center justify-between px-3 pb-2 rounded-none rounded-b-lg bg-gray-200/50">
                <div class="mt-1.5">
                    <button
                        type="button"
                        class="relative group/ico_attach_multimedia_for_comment"
                    >
                        <svg
                            viewBox="0 0 512 512"
                        ...
                        >
                            <path
                                ...
                                class="transition-colors duration-150 fill-none"
                                :class="[
                                    totalAttachment === 0
            ...
            <template v-if="cancelFromWithin">
                <p class="text-xs">Pulsar ESC para <button @click="cancellingEditingItem(false, {})" class="text-sky-500 hover:underline edit_block_item">cancelar</button></p>
            </template>
            <template v-else>
                <p class="text-xs"><button @click="cancellingEditingItem(false, {})" class="text-sky-500 hover:underline">Cancelar</button></p>
            </template>
            ...
            <div
                ...
                class="flex gap-4 mx-3 mt-2 w-fit"
            >
                <template
                    v-for="(
                        myFile, index
                ...
                >
                    <div class="flex flex-col">
                        <div class="flex gap-2">
                            <div
                                class="relative text-gray-500 border w-fit"
                                :class="
