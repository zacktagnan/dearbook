...
<template>
    <BaseModal v-model="show" :z-index="'z-50'" :dialog-panel-extra-classes="'max-w-lg'" @callCloseModal="closeModal">
        ...
        <div class="overflow-auto" :class="[
            ...
            <div v-if="showWarningExtensions" class="m-4">
                <div class="px-3 py-2 leading-4 border-l-4 border-amber-500 bg-amber-200">
                    ...
                    <small class="dark:text-gray-700">{{ allowedMimeTypes }}</small>
                </div>
            </div>
            ...
            <div v-if="attachmentFilesComputed.length > 0" class="m-[14px]">
                <div class="grid gap-3 mt-1 overflow-auto h-60" :class="[
                    ...
                    <div v-for="(
                        ...
                        <div class="relative flex flex-col items-center justify-center text-gray-500 border-2 dark:border-slate-700 aspect-square bg-sky-200 dark:bg-cyan-900 group"
                            :class="attachmentErrors[index]
                                ? 'border-red-400'
                                : ''
                                ">
                            <div v-if="myFile.deleted"
                                class="absolute inset-x-0 bottom-0 z-40 flex items-center justify-between px-2 py-1 text-red-700 dark:text-red-900 bg-red-400/75">
                                ...
                                <button @click="
                                    ...
                                    class="p-1 text-red-700 dark:text-red-900 rounded-full cursor-pointer hover:text-white hover:bg-red-700 dark:hover:text-white dark:hover:bg-red-700">
                            ...
                            <button @click="
                                ...
                                " title="Excluir"
                                class="absolute flex items-center justify-center text-gray-100 bg-gray-300 hover:bg-gray-400 dark:text-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition-all rounded-full opacity-0 cursor-pointer w-7 h-7 group-hover:opacity-100 right-2 top-2">
        ...
        <div
            class="flex p-[14px] mx-[14px] mt-[14px] border border-gray-300 dark:bg-slate-800 rounded-md justify-between items-center">
